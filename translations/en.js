// Complete English translation file with ALL keys (existing + missing)
// Use this file as reference for translating to other languages
...
export const en = {
  ...
  download: {
    ...
    subtitle:
      "Free to try. Process your files and preview your cuts. Pay only when you're ready to export.",
  ...
  whyAutoTrim: {
    ...
    features: {
      saveHours: {
        ...
        description:
          "Stop wasting time manually trimming silences, filler words and awkward pauses.",
        subtitle: "AutoTrim cuts your raw footage in seconds.",
      },
      oneTimeline: {
        title: "One Clean Timeline",
        description:
          "No puzzle to reassemble. Export one polished XML timeline directly to your editor.",
        subtitle: "All clips on one timeline, ready to go.",
      },
      fastPrivate: {
        title: "Super Fast, Private, Local",
        description:
          "No cloud processing. Everything runs offline, on your machine.",
  ...
  timeComparison: {
    ...
    subtitle:
      "Let's talk numbers. Here's what happens with just 30 min of raw footage:",
    table: {
      method: "Method",
    ...
    testimonial:
      '"I used to spend hours importing multiple XML timelines. With Trimly, it\'s literally seconds."',
    testimonialAuthor: "— Every editor, ever.",
    badges: {
      timeSaved: {
        title: "Time Saved",
        description:
          "On average, editors save 46 minutes per 30-minute raw video",
      },
      fasterThanManual: {
        title: "Faster Than Manual Editing",
        description:
          "AutoTrim processes 4 files in parallel thanks to native Rust code",
      },
      xmlTimeline: {
        title: "XML Timeline",
  ...
  features: {
    ...
    list: {
      parallel: {
        ...
        description:
          "Powered by Rust & Tauri for insane speed. Up to 4 simultaneous jobs, trimming multiple files at once.",
      },
      timeline: {
        title: "One-click Timeline Export",
        description:
          "No more puzzle pieces. Export a single, ready-to-edit XML/FCPXML timeline directly to your editing software.",
      },
      cuts: {
        title: "Clean, Precise Cuts",
        description:
          "Adjustable silence thresholds, padding, and cut precision. Exactly the way you want it.",
      },
      privacy: {
        title: "Zero Uploads",
        description:
          "Everything happens right on your machine. Secure, private, blazing-fast.",
      },
      license: {
        title: "Lifetime License",
        description:
          "Pay once, use forever. No hidden costs, no subscriptions.",
      },
      ai: {
        title: "Multilingual Interface & AI (coming soon)",
        description:
          "Automatic detection of filler words, repetitions, and hesitations in multiple languages. On-device, no cloud fees.",
      },
    },
  },
  processSteps: {
  ...
  howItWorks: {
    ...
    steps: {
      step1: {
        ...
        description:
          "Drag-and-drop your files into the app. No clutter, no mess.",
      },
      step2: {
        title: "Step 2: Let AutoTrim Run",
        description:
          "Parallel audio analysis automatically trims silences. Customize settings if you want, or just go with the defaults (they're good).",
      },
      step3: {
        title: "Step 3: Import Your Timeline",
        description:
          "Download one complete XML/FCPXML timeline. Open it in Final Cut, Premiere, or Resolve. Start editing immediately.",
      },
    },
    conclusion:
    ...
    comparison: {
      ...
      autoTrim:
        "With AutoTrim, you drop all your files in, they process in parallel, and you get one finished timeline.",
      otherTools:
        "With other tools, you process files one-by-one, export one XML per clip, and manually stitch everything together — wasting minutes on every project.",
    },
  },
  videoDemo: {
  ...
  perksGrid: {
    ...
    subtitle:
      "From drag-and-drop to clean XML, AutoTrim is packed with features that save time — and sanity.",
    badges: {
      popular: "Popular",
    ...
    perks: {
      dragDrop: {
        ...
        description:
          "Drop any number of clips; AutoTrim ingests them instantly, whatever the format.",
      },
      smartPresets: {
        title: "Smart Presets",
        description:
          "YouTube, Podcast, Vlog… one click applies the perfect settings.",
      },
      fineTune: {
        title: "Fine-Tune Cuts",
        description:
          "Silence threshold, pre/post-roll, min gap – dial in your exact editing style.",
      },
      xmlExport: {
        title: "Single or Multi-XML",
        description:
          "Export one clean timeline or individual XMLs – no more puzzle pieces.",
      },
      localProcessing: {
        title: "100% Local Processing",
        description:
          "AI, video processing, everything runs on your machine. No uploads, no waiting, maximum speed.",
      },
      parallelProcessing: {
        title: "Parallel Processing",
        description:
          "Max out your cores: up to 4 jobs run side-by-side for zero downtime.",
      },
      repetitionRemover: {
      ...
      optimizedPro: {
        ...
        description:
          "AutoTrim is built for the hardware you already own. It runs AI models locally, using the full power of your CPU and GPU — with no slow uploads and no extra server costs.",
      },
    },
  },
  whoIsItFor: {
    ...
    subtitle:
      "Whether you're creating content full-time or just getting started, AutoTrim saves you hours every week.",
    stats: {
  ...
  timeSavings: {
    ...
    realCase: {
      ...
      vsOtherTools: {
        ...
        sequential:
          "Sequential: 6 × 50 s = 5 min + merge 6 × 2 min 30 s = 15 min → 20 min total",
  ...
  ai: {
    ...
    description:
      "AutoTrim's AI-enhanced update detects filler words, repetitions, and hesitations instantly—still entirely on your device.",
    ...
    table: {
      ...
      rows: {
        ...
        aiCost: {
          label: "AI & Cost",
          autoTrim:
            "Runs entirely on your computer — no extra cost, no recurring payment",
          otherTools:
            "Requires subscription to access AI features, recurring fees",
        },
      },
    },
  ...
  about: {
    ...
    description:
      "AutoTrim was created by Benjamin Code, a professional developer and YouTuber who spent over a decade manually editing videos.",
    quote:
      '"I built AutoTrim because I couldn\'t afford to waste more time. Now, neither can you."',
  },
  roadmap: {
    ...
    table: {
      ...
      rows: {
        ...
        finalOutput: {
          ...
          timebolt:
            "One XML per clip — manual merge required in Final Cut / Premiere",
        },
        realWorldSpeed: {
          label: "Real-World Speed",
          autoTrim:
            "48× faster on multi-clip projects (1 min for 30 min of footage)",
          timebolt:
            "Time multiplied by the number of clips (20+ minutes for same project)",
        },
        userExperience: {
          label: "User Experience (UX)",
          autoTrim: "Minimal clicks, friction-free workflow",
          timebolt:
            "Repetitive steps for every single clip — tedious for large projects",
        },
        interface: {
          label: "Interface (UI)",
        ...
        featureQuality: {
          ...
          autoTrim:
            "Fewer features, but all highly optimized and reliable (works perfectly in English, Spanish, Chinese and any languages)",
          timebolt:
            "Many features, but several poorly implemented (e.g., HumCheck unreliable in French, FastForward/PunchZoom inconsistent)",
        },
        aiCost: {
          label: "AI & Cost",
          autoTrim:
            "Runs entirely on your computer — no extra cost, no subscriptions",
        ...
        bestFor: {
          label: "Best For",
          autoTrim:
            "Professionals and creators who value speed, simplicity, and consistent results",
          timebolt:
            "Users willing to manage slower workflows and more manual assembly",
        },
      },
    },
    winner: {
  ...
  compareDescript: {
    ...
    subtitle:
      "AutoTrim is a lightning-fast standalone tool for professional editors. Descript is a cloud-based all-in-one editor with text-based editing. See which approach fits your workflow.",
    table: {
      headers: {
        feature: "Feature",
        autoTrim: "AutoTrim",
      ...
      rows: {
        platformWorkflow: {
          ...
          descript:
            "All-in-one editor with built-in editing, text-based workflow",
        },
        processingStyle: {
          label: "Processing Style",
          autoTrim:
            "Drag & drop multi-clip → parallel silence/filler removal → single timeline export",
          descript: "Upload clip, transcribe, then edit via transcript UI",
        },
        aiExecution: {
          label: "AI Execution",
          autoTrim:
            "Runs locally — uses your machine's CPU/GPU, no extra costs",
          descript:
            "AI runs on the cloud — requires internet, additional wait time",
        },
        pricingStructure: {
          label: "Pricing Structure",
          autoTrim:
            "One-time purchase (annual or lifetime), no recurring cloud fees",
          descript:
            "Subscription $12–$24/month; free tier limited to 1 hour/month with watermarks",
        },
        silenceRemoval: {
          label: "Silence & Filler Removal",
          autoTrim: "Fast, optimized for pro editors — handles clips in batch",
          descript:
            "Text-based removal, but slower exports and potential quirks",
        },
        advancedTools: {
          label: "Advanced Editing Tools",
          autoTrim:
            "Focused on core trimming — minimal friction, highly reliable",
          descript:
            "Rich features: transcription, green screen, overdub, AI avatars, stock B-roll",
        },
        performanceUX: {
          label: "Performance & UX",
          autoTrim:
            "Lightning-fast, clean interface — designed for high-efficiency workflows",
          descript:
            "Unique text-editor interface; slower performance and exports reported",
        },
        bestFor: {
          label: "Best Suited For",
          autoTrim:
            "Editors wanting maximum speed, control, and low-cost execution",
          descript:
            "Creators who prefer an AI-heavy, all-in-one environment with subscriptions",
        },
      },
    },
    winner: {
