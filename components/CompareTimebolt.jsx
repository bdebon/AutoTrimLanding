  ...
  const tableData = [
    {
      ...
      autoTrimWins: true,
      autoTrimImage: "/assets/img/gif1.gif", // GIF montrant le drag & drop multiple
    ...
    },
    {
      ...
      autoTrimWins: true,
      highlight: true,
      autoTrimImage: "/assets/img/gif2.gif", // GIF montrant le traitement parallèle de 3 vidéos
    ...
    },
    {
      ...
      autoTrimWins: true,
      autoTrimImage: "/assets/img/AutoTrim/interface.jpg", // Interface moderne et épurée
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 bg-gradient-to-r from-gray-50 to-gray-100 border-b-2 border-gray-200">
            ...
            <div className="p-6 font-semibold text-center bg-gradient-to-br from-green-50 to-emerald-50 border-x-2 border-gray-200">
              <div className="flex items-center justify-center gap-2">
                ...
                <span className="text-green-700">{t("compareTimebolt.table.headers.autoTrim")}</span>
              </div>
            </div>
              ...
              <div className="p-6">
                <div className="space-y-4">
                  <div className="flex items-start gap-3">
                    ...
                    <span className="text-gray-600">{row.timebolt}</span>
                  </div>
                  {row.timeboltImage && (
