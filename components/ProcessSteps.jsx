  ...
  useLayoutEffect(() => {
    const ctx = gsap.context(() => {
      ...
      cards.forEach((card, i) => {
        ...
        if (gif) gsap.set(gif, { opacity: 0, y: 18 });
          ...
          {steps.map((step, index) => (
            ...
            >
              ...
              <div
                ...
                data-idx={index}
                className="bg-gray-50 rounded-2xl overflow-hidden shadow-lg h-full flex flex-col"
              >
                {/* GIF */}
                ...
                <div className="p-8 md:p-12 flex flex-col flex-1">
                  <div className="flex items-center gap-4 mb-4">
                    <span
                      ...
                      className="flex items-center justify-center w-12 h-12 bg-gradient-to-br from-primary-500 to-primary-600 text-white rounded-full font-bold text-lg"
                    >
                      {step.number}
                    </span>
                    <h3
